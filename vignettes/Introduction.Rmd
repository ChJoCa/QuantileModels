...
2.  In the original work, the bandwidth is calculated using k-nearest neighbours. However, in this implementation, it is calculated based on the multivariate posterior proposal [@white2015], whereas they use the one proposed by @machado2013.
...
Furthermore, you can use the S3 plot() method for the object returned by the CAViaR() function to visualise the result graphically.
