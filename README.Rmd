...
The first is the Symmetric absolute value and the Asymmetric Slope models from @engle2004. Of course, there are other spcifications, and all can be estimated for a given order of p autoregressive quantile and q order of lagged Y values.
